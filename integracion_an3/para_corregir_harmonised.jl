...
# ╔═╡ 4b85275e-7320-11ec-161f-69383784db68
using JSON, DataFrames,CSV, XLSX

# ╔═╡ caf23c5c-fdfa-4bc5-8bed-c6188ce4e276
begin
	df = DataFrame(XLSX.readtable("a_partir_de_ahora_es_manual.xlsx","Sheet1")...)
	open("plantilla.json") do file
		global traducciones=JSON.parse(file)
	end
end
