...
# ╔═╡ 3b276724-a2f4-11ec-224d-995f52b5cdc5
using GoogleDrive, CSV, DataFrames,XLSX

# ╔═╡ 59638cc2-74c9-4e93-8000-691a57ccf2c2
begin
	foods = DataFrame(XLSX.readtable("foods.xlsx", "_")...) 
	bpc = DataFrame(XLSX.readtable("bpc.xlsx", "Ingredientes_Formatted_V1")...)
end

# ╔═╡ ba27661e-cd2d-44d9-ace7-dd78835f0d8e
filter(x ->  x["Info para Reporte"] |> ismissing, bpc)

# ╔═╡ faec5b45-1820-4cda-a976-b5b8a8bc5930
filter(bpc -> bpc."Info para Reporte" .|> x -> length(x) < 3, bpc) |> x -> CSV.write("filtrados",x)
